...
public class incomeController {
    ...
    private void submitClick(ActionEvent event) throws IOException {
        ...
        try {
            if (checker1()) {
                p.println(date1.getValue() +","+ source1.getText() + ","+amount1.getText() +","+ description1.getText()+",income");
            } else {
                status.setVisible(true);
                status.setText("No Values Inputted");
            }
            if (checker2()) {
                p.println(date2.getValue() +","+ source2.getText() +","+ amount2.getText() +","+ description2.getText()+",income");
            }
            if (checker3()) {
                p.println(date3.getValue() +","+ source3.getText() +","+ amount3.getText() +","+ description3.getText()+",income");
            }
            if (checker4()) {
                p.println(date4.getValue() +","+ source4.getText() +","+ amount4.getText() +","+ description4.getText()+",income");
            }
            if (checker5()) {
                p.println(date5.getValue() +","+ source5.getText() +","+ amount5.getText() +","+ description5.getText()+",income");
            }
        }
        catch (Exception e){
